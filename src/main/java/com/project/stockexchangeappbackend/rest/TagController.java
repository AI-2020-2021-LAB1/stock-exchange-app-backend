...
public class TagController {
    ...
    public TagDTO getTag(@ApiParam(value = "The tag's name.") @PathVariable(value = "name") String tag) {
    ...
    public Page<TagDTO> getTags(@ApiIgnore Pageable pageable, TagSpecification specification) {
        return tagService.getTags(pageable, specification)
