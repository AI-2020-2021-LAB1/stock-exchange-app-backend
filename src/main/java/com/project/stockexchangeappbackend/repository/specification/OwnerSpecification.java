...
@And({
        @Spec(path = "u.email", spec = LikeIgnoreCase.class, params = {"email"}),
        @Spec(path = "u.firstName", spec = LikeIgnoreCase.class, params = {"firstName"}),
        @Spec(path = "u.lastName", spec = LikeIgnoreCase.class, params = {"lastName"}),
        @Spec(path = "u.money", spec = GreaterThanOrEqual.class, params={"money>"}),
        @Spec(path = "u.money", spec = LessThanOrEqual.class, params={"money<"}),
